...
def SortLR(target, type_cell, cellname, LRexp):
    ...
    if len(LRcorr)==0:
        sorted_LRcorr = 'No key L-R pairs found'
    else:
...
if __name__ == '__main__':
    ...
    if sorted_LRcorr == 'No key L-R pairs found':
        print('No key L-R pairs found')
        fw = open(fold + os.sep + 'target_LR.txt', 'w')
        fw.write('No key L-R pairs found')
        fw.close()
